...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002444360071 , -1002227852055').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1001315120330')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002485452013')
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/MRADBOT_OFFICIALS")
VERIFY2_URL = environ.get('VERIFY2_URL', "earn4link.in")
VERIFY2_API = environ.get('VERIFY2_API', "2bb1874d1cead1c3145196105eef40dad2090ef4")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'earn4link.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '2bb1874d1cead1c3145196105eef40dad2090ef4')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002352495353').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+NOpOGcYcGt5iYzA1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MRADBOT_OFFICIALS')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002380018292')).split()]
